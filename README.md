...
* The [dev container](./.devcontainer) sets up the github codespaces cloud environment, enabling development in open source technologies using computers without ADMIN privileges.
