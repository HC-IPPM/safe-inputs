...
import '../App.css'
import '../i18n'
import { HStack, Box, Image, Link, Button, Flex, Text, Drawer,useDisclosure, DrawerBody, DrawerCloseButton, DrawerContent, DrawerFooter, DrawerHeader, DrawerOverlay, VStack } from "@chakra-ui/react";
...
export default function MenuIdea1Variant() {
    ...
    return (
        <>
            <Box bg='#EEEEEE'>
                <Flex w='100%' flex={1} justify={'space-between'} className="pagebody" id='pageMarginSetting' padding={'6px 8px'}as="header" >
                    ...
                    <Box id='pageMarginSetting' bg='transparent' fontFamily="Noto Sans" >
                        ...
                        <Box >
                        <Button colorScheme='teal' onClick={onOpen} as={Button}
                            aria-label='Options'
                            bg='transparent' color='gray'
                                ...
                                <DrawerFooter color='white' bg='grey'>
                                    <Box w='100%' fontSize={12}   >
                                        <HStack justify={'space-between'}>
                                            ...
                                            <Text>Mobile Applications </Text><Text>About Canada.ca </Text>
                                        </HStack>
                                        <HStack justify={'space-around'}>
                                            <Text>Terms &amp; Conditions </Text><Text>Privacy </Text>
                                        </HStack>
