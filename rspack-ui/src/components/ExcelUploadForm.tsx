...
const validationSchema = Yup.object().shape({
    file: Yup.mixed()
        ...
        .test("fileFormat", "Invalid file format", (value) => {
            return (
                value && ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"].includes(value.type)
            );
        }),
});
...
const ExcelUploadForm: React.FC<ExcelUploadFormProps> = ({ onSubmit }) => {
    ...
    return (
        <Formik
            ...
            onSubmit={(values: ExcelUploadFormValues, actions: FormikHelpers<ExcelUploadFormValues>) => {
